...
# au départ nous allions utiliser un histogramme avec matplotlib mais par souci de 
#simplicté nous avons décidé d'utiliser une autre solution avec les diagrammes bar pour obtenir le même rendu.
